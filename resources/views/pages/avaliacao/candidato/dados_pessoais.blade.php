        ...
        <div class="row">
            <div class="col col-12 col-md-6 col-lg-6 has-info">
                ...
                <input type="text" class="form-control font-weight-bold" id="nome"
                       value="{{mb_strtoupper($formularioUsuario->user->pessoa->nome_completo)}}" disabled>
            </div>

            <div class="col col-12 col-md-6 col-lg-6 has-info">
                <label for="cpf" class="font-weight-bold">CPF </label>
                <input type="text" class="form-control font-weight-bold" id="cpf"
                       value="{{mb_strtoupper($formularioUsuario->user->pessoa->cpf)}}" disabled>
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col col-12 col-md-6 col-lg-6 has-info">
                ...
                <input type="date" class="form-control font-weight-bold" id="data_nascimento"
                       value="{{mb_strtoupper($formularioUsuario->user->pessoa->data_nascimento)}}" disabled>
            </div>

            <div class="col col-12 col-md-6 col-lg-6 has-info">
                <label for="rg" class="font-weight-bold">RG </label>
                <input type="text" class="form-control font-weight-bold" id="rg"
                       value="{{mb_strtoupper($formularioUsuario->user->pessoa->rg)}}" disabled>
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col col-12 col-md-6 col-lg-6 has-info">
                ...
                <input type="text" class="form-control font-weight-bold" id="data_nascimento"
                       value="{{mb_strtoupper($formularioUsuario->user->pessoa->orgao_emissor)}}" disabled>
            </div>

            <div class="col col-12 col-md-6 col-lg-6 has-info">
                <label for="rg" class="font-weight-bold">EMAIL </label>
                <input type="text" class="form-control font-weight-bold" id="rg"
                       value="{{mb_strtoupper($formularioUsuario->user->pessoa->email)}}" disabled>
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col col-12 col-md-6 col-lg-6 has-info">
                ...
                <input type="text" class="form-control font-weight-bold" id="nacionalidade"
                       value="{{empty($formularioUsuario->user->pessoa->nacionalidade) ? 'NÃO INFORMADO' : mb_strtoupper($formularioUsuario->user->pessoa->nacionalidade)}}"
                       disabled>
            </div>
            ...
            <div class="col col-12 col-md-6 col-lg-6 has-info">
                ...
                <input type="text" class="form-control font-weight-bold" id="naturalidade"
                       value="{{empty($formularioUsuario->user->pessoa->naturalidade) ? 'NÃO INFORMADO' : mb_strtoupper($formularioUsuario->user->pessoa->naturalidade)}}"
                       disabled>
            </div>
        </div>
        <hr>
        <div class="row mt-4">
            <div class="col col-12 col-md-6 col-lg-6 has-info">
                ...
                <input type="text" class="form-control font-weight-bold" id="bairro"
                       value="{{empty($formularioUsuario->user->pessoa->endereco->bairro) ? 'NÃO INFORMADO' : mb_strtoupper($formularioUsuario->user->pessoa->endereco->bairro)}}"
                       disabled>
            </div>
            ...
            <div class="col col-12 col-md-6 col-lg-6 has-info">
                ...
                <input type="text" class="form-control font-weight-bold" id="rua"
                       value="{{empty($formularioUsuario->user->pessoa->endereco->rua) ? 'NÃO INFORMADO' : mb_strtoupper($formularioUsuario->user->pessoa->endereco->rua)}}"
                       disabled>
            </div>
        </div>
        <div class="row mt-4">
            <div class="col col-12 col-md-6 col-lg-6 has-info">
                ...
                <input type="text" class="form-control font-weight-bold" id="numero"
                       value="{{empty($formularioUsuario->user->pessoa->endereco->numero) ? 'NÃO INFORMADO' : mb_strtoupper($formularioUsuario->user->pessoa->endereco->numero)}}"
                       disabled>
            </div>
            ...
            <div class="col col-12 col-md-6 col-lg-6 has-info">
                ...
                <input type="text" class="form-control font-weight-bold" id="cep"
                       value="{{empty($formularioUsuario->user->pessoa->endereco->cep) ? 'NÃO INFORMADO' : mb_strtoupper($formularioUsuario->user->pessoa->endereco->cep)}}"
                       disabled>
            </div>
        </div>
        @if(!is_null($formularioUsuario->user->pessoa->endereco->complemento))
            <div class="row mt-4">
                <div class="col col-12 col-md-12 col-lg-12 has-info">
                    ...
                    <input type="text" class="form-control font-weight-bold" id="complemento"
                           value="{{empty($formularioUsuario->user->pessoa->endereco->complemento) ? 'NÃO INFORMADO' : mb_strtoupper($formularioUsuario->user->pessoa->endereco->complemento)}}"
                           disabled>
                </div>
            </div>
        @endif

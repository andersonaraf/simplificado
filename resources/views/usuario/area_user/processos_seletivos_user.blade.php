                        ...
                        @foreach($formularioUsuario as $formuser)
                            <tr class="table-striped">
                                ...
                                <td class="text-right">
                                    ...
                                    @if(is_null($formuser->recurso) && ($formuser->formulario->liberar_recurso == 1 || (strtotime($formuser->formulario->data_liberar_recurso) <= strtotime(date('Y-m-d H:i:s')) && strtotime($formuser->formulario->data_fecha_recurso) >= strtotime(date('Y-m-d H:i:s')))))
